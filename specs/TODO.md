...
|------|-------|------------|--------|
| 1 | 15,19,23,41,42,43,46,67,68,77,115,116,117 | -- | nixos-config, nix-infrastructure, services, ... |
| 2 | 78 | 77 | desktop |
...
117 [NOT STARTED] — Configure laptop lid-close to blank screen but not sleep (keep AI
...
116 [PLANNED] — Investigate and safely remediate a misplaced non-mail filesystem 
